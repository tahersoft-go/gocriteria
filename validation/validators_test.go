...
func TestGetFieldLabelAndValue(t *testing.T) {
	...
	t.Run("GetFieldLabelAndValue when there is label", func(t *testing.T) {
		message.SetFieldLables(&message.Labels{
			"test": "test2",
		})
		label, value := GetFieldLabelAndValue("test", []interface{}{"val"})
...
var validationTestCases []ValidationsTest = []ValidationsTest{
	...
	{Fn: IsEmail, Name: "IsEmail", Field: "email", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsEmail, "email", "test")},
	{Fn: IsRequired, Name: "IsRequired", Field: "email", Params: "test@email.com", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsRequired, Name: "IsRequired", Field: "email", Params: "", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsRequired, "email", "")},
	{Fn: IsNumber, Name: "IsNumber", Field: "age", Params: "20", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsNumber, Name: "IsNumber", Field: "age", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsNumber, "age", "test")},
	...
	{Fn: IsUrl, Name: "IsUrl", Field: "url", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUrl, "url", "test")},
	{Fn: IsUrl, Name: "IsUrl", Field: "url", Params: "", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUrl, "url", "")},
	{Fn: IsUrl, Name: "IsUrl", Field: "url", Params: "test:aa", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUrl, "url", "test:aa")},
	{Fn: IsUrl, Name: "IsUrl", Field: "url", Params: "https://.a.google.com", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUrl, "url", "https://.a.google.com")},
	{Fn: IsUrl, Name: "IsUrl", Field: "url", Params: "https://google.com.a.b", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUrl, "url", "https://google.com.a.b")},
	{Fn: IsAlpha, Name: "IsAlpha", Field: "name", Params: "test", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsAlpha, Name: "IsAlpha", Field: "name", Params: "test1", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsAlpha, "name", "test1")},
	{Fn: IsAlpha, Name: "IsAlpha", Field: "name", Params: "234", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsAlpha, "name", "234")},
	{Fn: IsLowerCase, Name: "IsLowerCase", Field: "name", Params: "test", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsLowerCase, Name: "IsLowerCase", Field: "name", Params: "tesT", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLowerCase, "name", "tesT")},
	{Fn: IsLowerCase, Name: "IsLowerCase", Field: "name", Params: "TEST", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLowerCase, "name", "TEST")},
	{Fn: IsUpperCase, Name: "IsUpperCase", Field: "name", Params: "TEST", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsUpperCase, Name: "IsUpperCase", Field: "name", Params: "tesT", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUpperCase, "name", "tesT")},
	{Fn: IsUpperCase, Name: "IsUpperCase", Field: "name", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsUpperCase, "name", "test")},
	{Fn: IsInt, Name: "IsInt", Field: "age", Params: "20", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsInt, Name: "IsInt", Field: "age", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsInt, "age", "test")},
	{Fn: IsInt, Name: "IsInt", Field: "age", Params: "1.23", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsInt, "age", "1.23")},
	{Fn: IsFloat, Name: "IsFloat", Field: "age", Params: "20.3", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsFloat, Name: "IsFloat", Field: "age", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsFloat, "age", "test")},
	...
	{Fn: IsJson, Name: "IsJson", Field: "json", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsJson, "json", "test")},
	{Fn: IsIp, Name: "IsIp", Field: "ip", Params: "127.0.0.1", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsIp, Name: "IsIp", Field: "ip", Params: "127.0.0.", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIp, "ip", "127.0.0.")},
	{Fn: IsIp, Name: "IsIp", Field: "ip", Params: "127.0.0.2345", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIp, "ip", "127.0.0.2345")},
	{Fn: IsIp, Name: "IsIp", Field: "ip", Params: "test", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIp, "ip", "test")},
	{Fn: IsIpV4, Name: "IsIpV4", Field: "ip", Params: "127.0.0.1", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsIpV4, Name: "IsIpV4", Field: "ip", Params: "127.0.0.", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV4, "ip", "127.0.0.")},
	{Fn: IsIpV4, Name: "IsIpV4", Field: "ip", Params: "127.0.0.2345", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV4, "ip", "127.0.0.2345")},
	{Fn: IsIpV4, Name: "IsIpV4", Field: "ip", Params: "2001:db8:3333:4444:5555:6666:7777:8888", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV4, "ip", "2001:db8:3333:4444:5555:6666:7777:8888")},
	{Fn: IsIpV6, Name: "IsIpV6", Field: "ip", Params: "2001:db8:3333:4444:5555:6666:7777:8888", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsIpV6, Name: "IsIpV6", Field: "ip", Params: "127.0.0.", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV6, "ip", "127.0.0.")},
	{Fn: IsIpV6, Name: "IsIpV6", Field: "ip", Params: "127.0.0.2345", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV6, "ip", "127.0.0.2345")},
	{Fn: IsIpV6, Name: "IsIpV6", Field: "ip", Params: "127.0.0.1", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsIpV6, "ip", "127.0.0.1")},
	{Fn: IsPort, Name: "IsPort", Field: "port", Params: "5600", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsPort, Name: "IsPort", Field: "port", Params: "-1", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsPort, "port", "-1")},
	{Fn: IsPort, Name: "IsPort", Field: "port", Params: "65536", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsPort, "port", "65536")},
	{Fn: IsDNSName, Name: "IsDNSName", Field: "dns", Params: "www.google.com", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsDNSName, Name: "IsDNSName", Field: "dns", Params: "127.0.0.1", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsDNSName, "dns", "127.0.0.1")},
	{Fn: IsDNSName, Name: "IsDNSName", Field: "dns", Params: "", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsDNSName, "dns", "")},
	...
	{Fn: IsHost, Name: "IsHost", Field: "host", Params: "..test.", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsHost, "host", "..test.")},
	{Fn: IsLatitude, Name: "IsLatitude", Field: "lat", Params: "-15.569", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsLatitude, Name: "IsLatitude", Field: "lat", Params: "-150.569", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLatitude, "lat", "-150.569")},
	{Fn: IsLatitude, Name: "IsLatitude", Field: "lat", Params: "15.569", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsLatitude, Name: "IsLatitude", Field: "lat", Params: "150.569", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLatitude, "lat", "150.569")},
	{Fn: IsLogitude, Name: "IsLogitude", Field: "lng", Params: "-77.0364", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsLogitude, Name: "IsLogitude", Field: "lng", Params: "-1500.569", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLogitude, "lng", "-1500.569")},
	{Fn: IsLogitude, Name: "IsLogitude", Field: "lng", Params: "77.0364", ExpectedValid: true, ExpectedError: nil},
	{Fn: IsLogitude, Name: "IsLogitude", Field: "lng", Params: "1500.569", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsLogitude, "lng", "1500.569")},
	...
	{Fn: IsAlphaNum, Name: "IsAlphaNum", Field: "name", Params: ".s", ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsAlphaNum, "name", ".s")},
	//{Fn: IsMin, Name: "IsMin", Field: "age", Params: []int{18, 17}, ExpectedValid: true, ExpectedError: nil},
	//{Fn: IsMin, Name: "IsMin", Field: "age", Params: 17, ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsMin, "age", 17)},
	//{Fn: IsMax, Name: "IsMax", Field: "age", Params: 18, ExpectedValid: true, ExpectedError: nil},
	//{Fn: IsMax, Name: "IsMax", Field: "age", Params: 19, ExpectedValid: false, ExpectedError: GetErrorMessageByFieldValue(message.Default.IsMax, "age", 19)},
}
